...
export class StatefulStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    new DeploymentStackPipeline(this, 'DeployStatusStatefulDeployPipeline', {
      unitAppTestConfig: {
        command: [],
      },
      githubBranch: 'main',
      ...
      stackName: 'DeployStatusStatefulDeployStack',
      stackConfig: {
        beta: getStatefulStackProps(),
        gamma: getStatefulStackProps(),
        prod: getStatefulStackProps(),
      },
      pipelineName: 'OrcaBus-DeployStatusStatefulMicroservice',
